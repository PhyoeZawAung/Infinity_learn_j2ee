            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <p class="lead mb-0">Join our community of educators and share your knowledge with students worldwide</p>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="teachingExperience" rows="4" 
                                              placeholder="Describe your teaching experience and methodology" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Sample Course Outline</label>
                                    <textarea class="form-control" name="courseOutline" rows="4" 
                                              placeholder="Provide a brief outline of a course you'd like to teach" required></textarea>
                                </div>
                            </div>
